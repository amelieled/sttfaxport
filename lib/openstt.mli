...
val mk_subst :
  thm obj -> (name obj * ty obj) list -> (var obj * term obj) list -> thm obj
...
val mk_impl_equal :
  thm obj -> thm obj -> term obj -> term obj -> term obj -> term obj -> thm obj

val mk_forall_equal :
  thm obj -> name obj -> term obj -> term obj -> ty obj -> thm obj
